...
import { FaUserEdit, FaUserFriends, FaClipboardList, FaCalendarAlt } from 'react-icons/fa';
...
export default function MenteeDashboardPage() {
  const actions = [
    ...
    {
      to: '/mentee/my-requests',
      icon: <FaClipboardList size={36} />, 
      label: 'My Requests',
    },
    {
      to: '/mentee/my-sessions',
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-160px)] px-4 py-8 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 animate-fade-in">
      <h1 className="text-3xl font-extrabold text-indigo-700 mb-8">Welcome, Mentee!</h1>
